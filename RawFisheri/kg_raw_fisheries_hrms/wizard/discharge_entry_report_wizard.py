...
class EntryReportWizard(models.TransientModel):
    _name = 'discharge.entry.report.wizard'
    _description = 'discharge.entry.report.wizard'
        ...
        for rec in self:
            ...
            if rec.vessel_id:
                ...
                for employee in employees:
                    entries = self.env['hr.discharge'].search(
    ...
    def action_print_pdf(self):
        ...
        return self.env.ref('kg_raw_fisheries_hrms.action_discharge_entries_report'
                            '').with_context(
