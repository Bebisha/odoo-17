...
class ShopEntryWizard(models.TransientModel):
    _name = 'shop.entry.wizard'
    _description = 'shop.entry.wizard'
    ...
    def action_create_entries(self):
        """ Button action to create Shop Entries """
        ...
        for employee in self.employee_ids:
            ...
            self.env['shop.entry'].create(vals)

    def action_create_from_employee_entries(self):
        """ Button Action To Create Discharge Entries From Employee Entries """
