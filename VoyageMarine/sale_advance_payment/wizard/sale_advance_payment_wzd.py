...
class AccountVoucherWizard(models.TransientModel):
    ...
    amount_advance = fields.Monetary(
        "Amount advanced", required=True, currency_field="journal_currency_id", compute="compute_amount_advance"
    )
    ...
    def compute_amount_advance(self):
        self.amount_advance = self.advance_percentage * self.amount_total
    ...
    def _prepare_payment_vals(self, sale):
        ...
        return {
            ...
            "ref": 'Advance Payment - ' + str(self.payment_ref) or 'Advance Payment - ' + str(sale.name),
    ...
    def make_advance_payment(self):
        ...
        if not self.payment_ref:
            self.payment_ref = self.order_id.name
