    ...
    def compute_sheet(self):
        ...
        for contract in self._filter_contracts(contracts):
            anchorage_entry = self.env['hr.employee.entry'].search(
                [('employee_id', '=', contract.employee_id.id), ('start_date', '>=', contract.date_start),
                 ('end_date', '<=', contract.date_end), ('state', '=', 'approved'),
            ...
            overtime = self.env['hr.employee.entry'].search(
                [('employee_id', '=', contract.employee_id.id), ('start_date', '>=', contract.date_start),
                 ('end_date', '<=', contract.date_end), ('state', '=', 'approved'), ('type_entry', '=', 'overtime')])
            print(overtime.name, "overtime")
            ...
            overtime_entry = sum(overtime.mapped('over_time'))
