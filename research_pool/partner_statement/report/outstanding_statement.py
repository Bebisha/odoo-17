...
class OutstandingStatement(models.AbstractModel):
    ...
    #     )
    #
    #     print(self.env.cr.dictfetchall(),'self.env.cr.dictfetchall()kkk')
    #     # diction = self.env.cr.dictfetchall()
    #     # print(diction,'llllllllllllllllll')
    #     # for rec in self.env.cr.dictfetchall():
    #     #     print(rec,'pppppppppppppppppppppppppp')
    #     for row in self.env.cr.dictfetchall():
    #         print('kkkkkkkkkkkkkkkk')
    #         res[row.pop("partner_id")].append(row)
    #         print(row,'tppppppppppp')
    #     return res
    ...
    def _get_account_display_lines(
        ...
        print(fetched_data, 'fet')  # Save the result in a variable
