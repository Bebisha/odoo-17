...
class SaleOrderLine(models.Model):
    ...
    def _action_launch_stock_rule(self, previous_product_uom_qty=False):
        ...
        procurements = []
        branch_ids = self.order_id.mapped('branch_ids')
        print(branch_ids,'dddddddddddvvvvvvvvvvvvddddd')
        for branch in self.branch_id:  # Iterate over the branch_ids
            for line in self:
                # Check if the line belongs to the current branch
                if line.branch_id != branch:
                    continue
