...
# Copyright 2023 Nicolae Postica <nicolae.postica2@gmail.com>
{
    ...
    'data': ['views/preview_attachement.xml'],
    # 'assets': {
    #     'web.assets_backend': [
    #         'drag_and_drop_binary_field/static/src/**/*',
    #     ],
    # },
    # 'assets': {
    #     'web.assets_backend': [
    ...
    #         'drag_and_drop_binary_field/static/src/xml/binary_field_views.xml',
    #         'drag_and_drop_binary_field/static/src/css/previews_css.css',
    #         # 'drag_and_drop_binary_field/static/src/css/binary_field.css',
    #     ],
    # },
    "post_load": None,
    "pre_init_hook": None,
