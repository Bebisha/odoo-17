odoo.define("website_sale_checkout_skip_payment.website_sale_checkout_skip_payment_tour", function (require) {
    "use strict";
    ...
    publicWidget.registry.websiteSaleCheckoutSkipPaymentTour = publicWidget.Widget.extend({
