...
class KgCommonOrder(models.Model):
    ...
    date_transaction = fields.Datetime(string="Date / Time of Transaction")
    start_date = fields.Datetime(string="Date / Time of Start")
    end_date = fields.Datetime(string="Date / Time of End")
...
class KgPharmacyOrder(models.Model):
    ...
    requested_given_unit= fields.Char(string="unit Of Measurement")
    dosage= fields.Char(string="Dosage")
    pharmacy_order_id = fields.Many2one('appointment.appointment', string='Pharmacy')
    frequency = fields.Char(string="Frequency")
    administratio_time = fields.Datetime(string="Administration Time")
