...
class res_company(models.Model):
    ...
    us_check_layout = fields.Selection(string="US Check Layout", required=True,
        help="Select the format corresponding to the check paper you will \
              be printing your checks on.\n"
