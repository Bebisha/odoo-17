...
class KgPatientIdentification(models.Model):
    ...
    patient_death_indicator = fields.Selection([('Y', 'Yes'),
                                                ('N', 'No')], string="Patient Death Indicator", default='N')
    identity_unknown_indicator = fields.Selection([('V', 'VIP'), ('T', 'Tourist'),
                                                   ('O', 'All Dubai Residents')], string="Identity Unknown Indicator",
                                                  help="V for VIP,T for Tourist and O for all residents in dubai ", default='O',
                                                  )
    ...
    employment_status = fields.Selection([('A', 'Active'), ('I', 'Inactivate')],
