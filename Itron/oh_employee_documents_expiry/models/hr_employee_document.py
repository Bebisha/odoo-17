...
class HrEmployeeDocument(models.Model):
    ...
    name = fields.Char(string='Document Number', required=True, copy=False,
                       help='You can give your Document number or Name if number not available.')
    ...
    document_types = fields.Selection([('emirates_id', 'Emirates ID'), ('aadhar', 'Aadhar Card'), ('oman_id', 'Oman ID'), ('bahrain_cpr', 'CPR Card'),
                                       ('driving', 'Driving Licence'), ('passport', 'Passport'), ('relieving_offer', 'Relieving Letter'), ('experience', 'Experience Certificate')],
                              string='Document Type', )
